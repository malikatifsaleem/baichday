...
import '../screens/product/sellerProfile.dart';
import 'SellerProfileScreen.dart';

class SellerMainNavigationScreen extends StatefulWidget {
  static const screenId = 'seller_main_nav_screen';
  const SellerMainNavigationScreen({Key? key}) : super(key: key);

  @override
  State<SellerMainNavigationScreen> createState() => _SellerMainNavigationScreenState();
}

class _SellerMainNavigationScreenState extends State<SellerMainNavigationScreen> {
  List pages = [
    const MyPostScreen(),
    const ChatScreen(),
