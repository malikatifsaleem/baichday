...
class _UserFormReviewState extends State<UserFormReview> {
  ...
  void initState() {
    ...
    _countryCodeController = TextEditingController(text: '+92');
  ...
  Future<void> saveProductToDatabase(categoryProvider, BuildContext context) {
    return authService.products.add(categoryProvider.formData).then((value) {
      ...
      customSnackBar(
          context: context, content: 'Posted Ad Successfully');
              ...
              child: Column(
                ...
                children: [
                  ...
                  ListTile(
                    ...
                    subtitle: Text(
                      '\u{20A8} ${categoryProvider.formData['price']}',
                      style: TextStyle(
                        color: blackColor,
                        fontWeight: FontWeight.bold,
                      ),
    ...
    return Form(
      ...
      child: FutureBuilder<DocumentSnapshot>(
        ...
        builder:
          ...
          snapshot.data!['contact_details'] != null &&
              snapshot.data!['contact_details']['mobile'] != null
              ? snapshot.data!['contact_details']['mobile']
