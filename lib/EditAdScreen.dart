...
class EditAdScreen extends StatefulWidget {
  ...
  EditAdScreen({ required this.productProvider});
  @override
...
class _EditAdScreenState extends State<EditAdScreen> {
  ...
  void initState() {
    ...
    _descriptionController.text = widget.productProvider.productData!['description'];
    _descriptionNode = FocusNode();
    _titleController.text = widget.productProvider.productData!['title'];
    _titleNode = FocusNode();
    _priceController.text = widget.productProvider.productData!['price'];
    ...
    images = widget.productProvider.productData!['images'];
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
          ...
          title: Text(
            '${widget.productProvider.productData!['subcategory']} Details',
      ...
      bottomNavigationBar: BottomNavigationWidget(
        ...
        onPressed: () async {
          if (_formKey.currentState!.validate()) {
            ...
            Auth().products.doc(widget.productProvider.productData!.id).update({
              'seller_uid': firebaseUser.user!.uid,
              'category': widget.productProvider.productData!['category'],
              'subcategory': widget.productProvider.productData!['subcategory'],
    ...
    customSnackBar(
    context: context, content: 'Updated Ad Successfully');
...
// Update _deleteImage method to remove image at the specified index
        ...
        child: SingleChildScrollView(
          child: Container(
            ...
            child: Column(
              ...
              children: [
                Text(
                  '${widget.productProvider.productData!['subcategory']}',
                  style: TextStyle(
                    color: blackColor,
                              ...
                              return Stack(
                                children: [
                                  Padding(
                                    ...
                                    child: Image.network(images[index], height: 80, width: 80),
                                  ),
                                  Positioned(
                                    // top:4,
                                    // right: 4,
